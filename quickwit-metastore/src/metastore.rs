...
pub trait Metastore: Send + Sync + 'static {
    /// Creates an index.
    /// This API creates an index metadata set in the metastore.
    /// If the index metadata set already exists, it will loaded.
    ...
    /// The SplitId is returned for convenienced but it is not generated by the metastore.
    ...
    /// Deletes a split.
    /// This API only takes split that are in Staged or in ScheduledForDeletion state.
