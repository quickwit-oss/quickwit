...
| `tag_fields` | Collection of fields already defined in `field_mappings` whose values will be stored in a dedicated `tags`. [Learn more about tags](../concepts/querying.md#tag-pruning). | [] |
