...
| `enable_cooperative_indexing` | Unable to share resources more efficiently when the number of actively written indexes is significantly higher than the number of cores but might decrease the overall indexing throughput. | `false` |
