...
BINARIES_GO_URL = "https://depot-read-api-generic.us1.ddbuild.io/magicmirror/magicmirror/@current/runtime/go/go{}/{}".format(GO_VERSION, "{}")

GO_SDKS = {
    "darwin_amd64": (
        "go{}.darwin-amd64.tar.gz".format(GO_VERSION),
        GO_DARWIN_AMD64_DIGEST,
    ),
    "darwin_arm64": (
        "go{}.darwin-arm64.tar.gz".format(GO_VERSION),
        GO_DARWIN_ARM64_DIGEST,
    ),
    "linux_amd64": (
        "go{}.linux-amd64.tar.gz".format(GO_VERSION),
        GO_LINUX_AMD64_DIGEST,
    ),
    "linux_arm64": (
        "go{}.linux-arm64.tar.gz".format(GO_VERSION),
        GO_LINUX_ARM64_DIGEST,
    ),
}
...
git_repository(
    ...
    commit = "a6b27e21659b027d665bf7db387322e133d32cec",
)
