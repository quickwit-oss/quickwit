...
use quickwit_index_management::IndexManagementService;
use quickwit_proto::{
    CreateIndexRequest, DeleteIndexRequest, IndexMetadataRequest, ListAllSplitsRequest,
...
pub fn index_management_handlers(
    index_service_mailbox_opt: Option<Mailbox<IndexManagementService>>,
...
async fn get_index_metadata(
    index_id: String,
    index_service_mailbox: Mailbox<IndexManagementService>,
...
async fn create_index(
    ...
    let create_index_req = CreateIndexRequest {
        index_config_serialized_json: serde_json::to_string(&index_config).unwrap(),
    };
    let index_metadata = index_service_mailbox
...
async fn delete_index(
    ...
    let delete_req = DeleteIndexRequest { index_id };
