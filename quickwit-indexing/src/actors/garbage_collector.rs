...
/// TODO ideally we want clean up all staged splits every time we restart the indexing pipeline, but the grace
/// period strategy should do the job for the moment.
