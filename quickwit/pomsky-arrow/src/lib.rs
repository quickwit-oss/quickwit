...
//! (`schema_mapping` + `fast_field_reader`). Two independent consumers share
//! this small surface: the Trino columnar `SearchSplit` endpoint and the full
//! DataFusion / SQL connector.
//!
//! # What this crate owns
//!
//! - **Schema mapping** — tantivy schema → Arrow schema ([`schema_mapping`]).
...
pub use schema_mapping::{
    ...
    tantivy_schema_to_arrow_from_searcher, tantivy_schema_to_arrow_with_multi_valued,
};
