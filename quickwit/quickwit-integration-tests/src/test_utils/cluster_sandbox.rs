...
impl TestNodeConfig {
    async fn build_node_config(
        ...
        config.cloudprem_config.create_dd_logs_index = self.create_dd_logs_index;
        config.cloudprem_config.create_dd_metrics_index = self.create_dd_metrics_index;
        config.cloudprem_config.create_dd_traces_index = self.create_dd_traces_index;
        config
    }
}
