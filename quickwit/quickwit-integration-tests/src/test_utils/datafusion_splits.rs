...
//! Parquet-split staging helpers for the DataFusion full-stack integration
//! test. Only compiled under `--features datafusion`.
...
/// and publish it. Tag columns (`service`, `env`, `datacenter`, `region`,
/// `host`) present in the batch schema are indexed for split-level pruning.
