...
pub mod test_suite {
    ...
    use quickwit_proto::metastore::{
        AddSourceRequest, CreateIndexRequest, DeleteQuery, IndexMetadataRequest,
        ListIndexesRequest, PublishSplitsRequest, StageSplitsRequest,
    };
    use quickwit_proto::{
        DeleteIndexRequest, DeleteSourceRequest, DeleteSplitsRequest, IndexMetadataRequest,
        IndexUid, ListSplitsRequest, MarkSplitsForDeletionRequest, ResetSourceCheckpointRequest,
        ToggleSourceRequest,
    };
    ...
    use crate::metastore::{index_metadata, ListSplitsResponseExt};
    use crate::{
        CreateIndexRequestExt, IndexMetadata, IndexMetadataResponseExt, ListIndexesResponseExt,
        ListSplitsQuery, Metastore, MetastoreError, Split, SplitMaturity, SplitMetadata,
    ...
    async fn cleanup_index(metastore: &dyn Metastore, index_uid: IndexUid) {
        // List all splits.
        let response = metastore
            .list_splits(ListSplitsRequest::all(index_uid.clone()))
            .await
            .unwrap();
        let all_splits = response.deserialize_splits_metadata().unwrap();
        ...
        if !all_splits.is_empty() {
            ...
            let mark_splits_request =
                MarkSplitsForDeletionRequest::new(index_uid.clone(), all_split_ids);
            metastore
            ...
            // Delete splits.
            let delete_splits_request = DeleteSplitsRequest::new(index_uid.clone(), all_split_ids);
            metastore
        ...
        // Delete index.
        let delete_index_request = DeleteIndexRequest::new(index_uid);
        metastore.delete_index(delete_index_request).await.unwrap();
    }
    ...
    pub async fn test_metastore_create_index<MetastoreToTest: Metastore + DefaultForTest>() {
        ...
        let index_metadata_response = metastore
    ...
    //         StageSplitsRequest::try_from_split_metadata(index_uid, split_metadata)?;
    //     metastore.stage_splits(stage_splits_request).await.unwrap();

    //     // TODO: We should not be able to delete an index that has remaining splits, at least not
    // as     // a default behavior. Let's implement the logic that allows this test to pass.
    //     // let error = metastore.delete_index(index_uid).await.unwrap_err();
    //     // assert!(matches!(error, MetastoreError::IndexNotEmpty { .. }));
    //     // let splits =
    //     // metastore.list_splits(ListSplitsRequest::all(index_uid.clone())).await.unwrap();
    ...
    //         AddSourceRequest::try_from_source_config(index_uid, source_config.clone()).unwrap();
    ...
    //             .unwrap();
    //     let add_source_error = metastore.add_source(add_source_request).await.unwrap_err();
    //     assert!(matches!(
    //         add_source_error,
    ...
    //     };
    //     metastore.delete_source(delete_source_request).await.unwrap();
    ...
    //     };
    //     assert!(matches!(
    //         metastore.delete_source(delete_source_request).await.unwrap_err(),
    ...
    //     let source_ids: Vec<String> = (0..2).map(|i|
    // format!("{index_id}--source-{i}")).collect();     let split_ids: Vec<String> =
    // (0..2).map(|i| format!("{index_id}--split-{i}")).collect();
    ...
    //         let publish_splits_request = PublishSplitsRequest::new(index_uid.clone(), [split_id],
    // [], None);         metastore
    ...
    //         create_index_response_uid =
    // metastore.create_index(create_index_request).await.unwrap();         let index_uid:
    // IndexUid = create_index_response.index_uid.into();
    ...
    //     let index_uid = IndexUid::new(index_id.clone());
    //     let index_uri = format!("ram:///indexes/{index_id}");
    //     let index_config = IndexConfig::for_test(&index_id, &index_uri);
    ...
    //         metastore
    //             .mark_splits_for_deletion(index_uid.clone(), &[&split_id_1])
    //             .await
    //             .unwrap();
    ...
    //     cleanup_index(metastore.as_ref(), index_uid).await
    // }
    ...
    //             .unwrap_err();
    //         assert!(
    //             matches!(error, MetastoreError::SplitsNotDeletable { split_ids } if split_ids ==
    // [split_id_1.clone()])         );
    ...
    //     };
    //     metastore
    //         .stage_splits(index_uid.clone(), vec![split_metadata_1])
    //         .await
    //         .unwrap();
    ...
    //     };
    //     metastore
    //         .stage_splits(index_uid.clone(), vec![split_metadata_2])
    //         .await
    //         .unwrap();
    //     metastore
    ...
    //     };
    //     metastore
    //         .stage_splits(index_uid.clone(), vec![split_metadata_3])
    //         .await
    //         .unwrap();
    //     metastore
    ...
    //     metastore
    //         .mark_splits_for_deletion(index_uid.clone(), &[&split_id_3])
    //         .await
    //         .unwrap();
    ...
    //     let error = metastore
    //         .delete_splits(IndexUid::new("index-not-found"), &[])
    //         .await
    //         .unwrap_err();
    ...
    //     let error = metastore
    //         .delete_splits(index_uid.clone(), &[&split_id_1, &split_id_2])
    //         .await
    //         .unwrap_err();
    ...
    //     metastore
    //         .mark_splits_for_deletion(index_uid.clone(), &[&split_id_1, &split_id_2])
    //         .await
    //         .unwrap();
    ...
    //         .delete_splits(
    //             index_uid.clone(),
    //             &[&split_id_1, &split_id_2, "split-not-found"],
    //         )
    //         .await
    //         .unwrap();
    ...
    //     metastore
    //         .mark_splits_for_deletion(index_uid.clone(), &[&split_id_3, &split_id_4])
    //         .await
    //         .unwrap();
    ...
    //         };
    //         metastore
    //             .stage_splits(index_uid.clone(), vec![split_metadata_6.clone()])
    //             .await
    //             .unwrap();
    ...
    //             index_uid: IndexUid::new("does-not-exist:12345").to_string(),
    //             ..delete_query.clone()
    //         })
    //         .await
    //         .unwrap_err();
    ...
    // pub async fn test_metastore_last_delete_opstamp<MetastoreToTest: Metastore +
    // DefaultForTest>() {     let metastore = MetastoreToTest::default_for_test().await;
    ...
    //         .last_delete_opstamp(index_uid_1.clone())
    //         .await
    //         .unwrap();
    ...
    //         .last_delete_opstamp(index_uid_2.clone())
    //         .await
    //         .unwrap();
    ...
    //         .list_delete_tasks(index_uid_1.clone(), 0)
    //         .await
    //         .unwrap();
    //     assert_eq!(all_index_id_1_delete_tasks.len(), 2);

    //     let recent_index_id_1_delete_tasks = metastore
    //         .list_delete_tasks(index_uid_1.clone(), delete_task_1.opstamp)
    //         .await
    //         .unwrap();
    ...
    //         metastore
    //             .stage_splits(index_uid.clone(), vec![split_metadata_4.clone()])
    //             .await
    //             .unwrap();
    //         metastore
    ...
    //             .unwrap();
    //         let splits = metastore
    //             .list_stale_splits(index_uid.clone(), 100, 1)
    //             .await
    //             .unwrap();
    //         assert_eq!(splits.len(), 1);
    //         assert_eq!(
    ...
    //         let splits = metastore
    //             .list_stale_splits(index_uid.clone(), 100, 4)
    //             .await
    //             .unwrap();
    ...
    //         let splits = metastore
    //             .list_stale_splits(index_uid.clone(), 20, 2)
    //             .await
    //             .unwrap();
    //         assert_eq!(splits.len(), 1);
    //         assert_eq!(
    ...
    //         let splits = metastore
    //             .list_stale_splits(index_uid.clone(), 10, 2)
    //             .await
    //             .unwrap();
    ...
    //             .update_splits_delete_opstamp(IndexUid::new("index-not-found"), &[&split_id_1],
    // 10) .await .unwrap_err(); error!(err=?metastore_err); assert!(matches!( metastore_err,
    //     MetastoreError::IndexDoesNotExist { .. } )); }
    ...
    //         let splits = metastore
    //             .list_stale_splits(index_uid.clone(), 100, 2)
    //             .await
    //             .unwrap();
    //         assert_eq!(splits.len(), 2);

    //         metastore
    //             .update_splits_delete_opstamp(index_uid.clone(), &[&split_id_1, &split_id_2],
    // 100)             .await
    //             .unwrap();
    ...
    //         let splits = metastore
    //             .list_stale_splits(index_uid.clone(), 200, 2)
    //             .await
    //             .unwrap();
    //         assert_eq!(splits.len(), 2);
    ...
    //     let stage_splits_request = StageSplitsRequest::try_from_split_metadata(index_uid,
    // split_metadata_1.clone());     metastore
    ...
    //     let stage_splits_request = StageSplitsRequest::try_from_split_metadata(index_uid,
    // split_metadata_1.clone());     let error = metastore
    //         .stage_splits(stage_splits_request)
    //         .await
    //         .expect_err(
    ...
    //         );
    //     assert!(
    //         matches!(error, MetastoreError::SplitsNotStaged { .. }),
    //         "Metastore should return a `SplitsNotStaged` error when attempting to perform an \
    //          operation that must not occur.",
    //     );

    //     let mark_splits_request = MarkSplitsForDeletionRequest::new(index_uid.clone(),
    // [&split_id_2]);     metastore
    //         .mark_splits_for_deletion(mark_splits_request)
    //         .await
    //         .unwrap();

    //     let stage_splits_request = StageSplitsRequest::try_from_split_metadata(index_uid,
    // split_metadata_2);     let error = metastore
    //         .stage_splits(stage_splits_request)
    //         .await
    //         .expect_err(
    //             "Metastore should not allow splits which are not `Staged` to be overwritten.",
...
macro_rules! metastore_test_suite {
    ($metastore_type:ty) => {
        ...
        mod common_tests {
            ...
            //     let _ = tracing_subscriber::fmt::try_init();
            //     crate::tests::test_suite::test_metastore_index_metadata::<$metastore_type>().
            // await; }
            ...
            //     let _ = tracing_subscriber::fmt::try_init();
            //     crate::tests::test_suite::test_metastore_publish_splits::<$metastore_type>().
            // await; }
            ...
            //     let _ = tracing_subscriber::fmt::try_init();
            //     crate::tests::test_suite::test_metastore_replace_splits::<$metastore_type>().
            // await; }
            ...
            //     let _ = tracing_subscriber::fmt::try_init();
            //     crate::tests::test_suite::test_metastore_delete_splits::<$metastore_type>().
            // await; }

            // #[tokio::test]
            // async fn test_metastore_list_all_splits() {
            //     let _ = tracing_subscriber::fmt::try_init();
            //     crate::tests::test_suite::test_metastore_list_all_splits::<$metastore_type>().
            // await; }
            ...
            //     let _ = tracing_subscriber::fmt::try_init();
            //     crate::tests::test_suite::test_metastore_toggle_source::<$metastore_type>().
            // await; }

            // #[tokio::test]
            // async fn test_metastore_delete_source() {
            //     let _ = tracing_subscriber::fmt::try_init();
            //     crate::tests::test_suite::test_metastore_delete_source::<$metastore_type>().
            // await; }

            // #[tokio::test]
            // async fn test_metastore_reset_checkpoint() {
            //     let _ = tracing_subscriber::fmt::try_init();
            //     crate::tests::test_suite::test_metastore_reset_checkpoint::<$metastore_type>().
            // await; }

            // #[tokio::test]
            // async fn test_metastore_create_delete_task() {
            //     let _ = tracing_subscriber::fmt::try_init();
            //     crate::tests::test_suite::test_metastore_create_delete_task::<$metastore_type>().
            // await; }
            ...
            //     let _ = tracing_subscriber::fmt::try_init();
            //     crate::tests::test_suite::test_metastore_list_delete_tasks::<$metastore_type>().
            // await; }

            // #[tokio::test]
            // async fn test_metastore_list_stale_splits() {
            //     let _ = tracing_subscriber::fmt::try_init();
            //     crate::tests::test_suite::test_metastore_list_stale_splits::<$metastore_type>().
            // await; }
