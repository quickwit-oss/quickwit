    ...
    pub async fn test_metastore_list_splits<MetastoreToTest: Metastore + DefaultForTest>() {
...

        {
            ...
            let query = ListSplitsQuery::for_index(index_id)
                ...
                .with_time_range_gte(0)
                .with_time_range_lt(99);
