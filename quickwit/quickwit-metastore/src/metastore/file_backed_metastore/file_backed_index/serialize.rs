...
impl From<VersionedFileBackedIndex> for FileBackedIndex {
    fn from(index: VersionedFileBackedIndex) -> Self {
        match index {
            VersionedFileBackedIndex::V3(index) => index.into(),
        }
    }
}

#[derive(Clone, Debug, Serialize, Deserialize)]
pub(crate) struct FileBackedIndexV3 {
    #[serde(rename = "index")]
...
impl From<FileBackedIndex> for FileBackedIndexV3 {
    fn from(index: FileBackedIndex) -> Self {
        Self {
...
impl From<FileBackedIndexV3> for FileBackedIndex {
    fn from(mut index: FileBackedIndexV3) -> Self {
