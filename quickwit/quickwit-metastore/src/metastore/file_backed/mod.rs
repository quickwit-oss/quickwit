...
use quickwit_proto::metastore::{
    ...
    MetastoreServiceStream, OpenShardSubrequest, OpenShardsRequest, OpenShardsResponse,
    PruneShardsRequest, PublishMetricsSplitsRequest, PublishSketchSplitsRequest,
