...
ALTER TABLE indexes ALTER COLUMN index_uid TYPE VARCHAR(77);

ALTER TABLE splits DROP COLUMN incarnation_id;
ALTER TABLE splits DROP CONSTRAINT IF EXISTS splits_index_id_fkey;
ALTER TABLE splits RENAME COLUMN index_id TO index_uid;
ALTER TABLE splits ALTER COLUMN index_uid TYPE VARCHAR(77);
...
ALTER TABLE delete_tasks ALTER COLUMN index_uid TYPE VARCHAR(77);
