...
mod tests {
    ...
    async fn test_counting_storage_counts_get_slice() {
        ...
        let (downloaded_bytes, downloaded_req) = counters.snapshot();
        assert_eq!(downloaded_bytes, 10);
        assert_eq!(downloaded_req, 2);
    }
