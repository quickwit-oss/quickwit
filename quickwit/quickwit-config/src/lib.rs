...
mod tests {
    ...
    use crate::{TestableForRegression, validate_index_id_pattern};

    #[test]
    fn test_print_fingerprints() {
        let source_config = crate::SourceConfig::sample_for_regression();
        let index_config = crate::IndexConfig::sample_for_regression();
        ...
        let combined_fingerprint = crate::indexing_pipeline_params_fingerprint(&index_config, &source_config);
