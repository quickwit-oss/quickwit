...
pub struct GetDebugInfoResponse {
    ...
    pub debug_info_json: ::prost::alloc::vec::Vec<u8>,
}
...
pub trait DeveloperService: std::fmt::Debug + Send + Sync + 'static {
    ...
    ) -> crate::cloudprem::CloudPremResult<GetDebugInfoResponse>;
    async fn pull_metrics(
        &self,
        request: PullMetricsRequest,
    ) -> crate::cloudprem::CloudPremResult<PullMetricsResponse>;
}
#[derive(Debug, Clone)]
...
pub mod mock_developer_service {
    ...
    impl DeveloperService for MockDeveloperServiceWrapper {
        ...
        ) -> crate::cloudprem::CloudPremResult<super::GetDebugInfoResponse> {
            self.inner.lock().await.get_debug_info(request).await
        }
        async fn pull_metrics(
            &self,
            request: super::PullMetricsRequest,
        ) -> crate::cloudprem::CloudPremResult<super::PullMetricsResponse> {
...
where
    ...
    >: tower::Service<
            ...
            Response = GetDebugInfoResponse,
            Error = crate::cloudprem::CloudPremError,
            Future = BoxFuture<GetDebugInfoResponse, crate::cloudprem::CloudPremError>,
        >
        + tower::Service<
            PullMetricsRequest,
            Response = PullMetricsResponse,
            Error = crate::cloudprem::CloudPremError,
            Future = BoxFuture<PullMetricsResponse, crate::cloudprem::CloudPremError>,
        >,
{
    async fn get_debug_info(
        &self,
