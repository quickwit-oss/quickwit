        ...
        impl FuncName {
            ...
            pub fn as_str_name(&self) -> &'static str {
                match self {
                    ...
                    Self::SplitBefore => "SPLIT_BEFORE",
                    Self::SplitAfter => "SPLIT_AFTER",
                    ...
                    Self::Switch => "SWITCH",
                    Self::SwitchWhen => "SWITCH_WHEN",
                    Self::CastString => "CAST_STRING",
                    Self::CastInt => "CAST_INT",
                    Self::TryCastInt => "TRY_CAST_INT",
                    Self::CastFloat => "CAST_FLOAT",
                    Self::TryCastFloat => "TRY_CAST_FLOAT",
