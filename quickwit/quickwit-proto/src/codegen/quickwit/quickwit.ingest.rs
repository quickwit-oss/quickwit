...
pub struct Shard {
    ...
    pub shard_state: i32,
    /// / Position up to which the follower has replicated the data.
    #[prost(uint64, optional, tag = "9")]
    pub replication_position_inclusive: ::core::option::Option<u64>,
    /// / Position up to which indexers have indexed and published the data.
    /// / It is updated asynchronously in a best effort manner by the indexers and indicates the position up to which the data can be safely deleted.
    #[prost(string, tag = "10")]
