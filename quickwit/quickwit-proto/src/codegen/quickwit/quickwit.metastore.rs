...
/// Immutable metadata embedded in a split bundle so that the split can be
/// reconstructed if the metastore is lost.
...
pub struct SplitRecoveryMetadata {
    ...
    pub num_docs: u64,
    #[prost(uint64, tag = "7")]
    pub uncompressed_docs_size_bytes: u64,
    #[prost(int64, optional, tag = "8")]
    pub time_range_start_inclusive: ::core::option::Option<i64>,
    #[prost(int64, optional, tag = "9")]
    pub time_range_end_inclusive: ::core::option::Option<i64>,
    #[prost(int64, tag = "10")]
    pub create_timestamp: i64,
    #[prost(bool, tag = "11")]
    pub mature: bool,
    #[prost(uint64, tag = "12")]
    pub maturation_period_secs: u64,
    ...
    /// Split IDs directly replaced when this split was published.
    #[prost(string, repeated, tag = "16")]
    pub parent_split_ids: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
}
#[derive(serde::Serialize, serde::Deserialize, utoipa::ToSchema)]
