//! Compute current fingerprint values after dependency updates

use quickwit_config::*;

fn main() {
    println!("Computing fingerprints with updated dependencies...");
    ...
    // Check heap size change from bytesize update
