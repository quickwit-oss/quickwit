...
/// Sort order column names for metrics. Columns not present in a batch are skipped.
...
/// Sort order column names for sketches. Same tag columns as metrics.
pub const SKETCH_SORT_ORDER: &[&str] = &[
    "metric_name",
    "service",
    "env",
    "datacenter",
