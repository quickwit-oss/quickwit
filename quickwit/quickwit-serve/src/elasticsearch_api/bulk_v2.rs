                ...
                Ok(IngestResponseV2 {
                    successes: vec![
                        IngestSuccess {
                            subrequest_id: 0,
                            index_uid: Some(
                                "my-index-1:00000000000000000000000000".parse().unwrap(),
                            ),
                        ...
                        IngestSuccess {
                            subrequest_id: 1,
                            index_uid: Some(
                                "my-index-2:00000000000000000000000000".parse().unwrap(),
                            ),
                            source_id: INGEST_V2_SOURCE_ID.to_string(),
                            shard_id: Some(ShardId::from(1)),
            ...
            .returning(|ingest_request| {
                ...
                Ok(IngestResponseV2 {
                    successes: vec![IngestSuccess {
                        subrequest_id: 0,
                        index_uid: Some("my-index-1:00000000000000000000000000".parse().unwrap()),
                        source_id: INGEST_V2_SOURCE_ID.to_string(),
                        shard_id: Some(ShardId::from(1)),
                        replication_position_inclusive: Some(Position::offset(0u64)),
                    }],
