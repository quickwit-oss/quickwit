...
pub(crate) fn cloudprem_ui_api_handlers(
    ...
    search_handler(search_service).recover(recover_fn).boxed()
}
...
impl ListQueryString {
    fn try_into_search_request(self) -> CloudPremUiResult<SearchRequest> {
        ...
        let search_request = quickwit_proto::search::SearchRequest {
            ...
            count_hits: CountHits::CountAll as i32, // FIXME
        };
        Ok(search_request)
    }
}
...
const _EVENT_TIMESTAMP_FIELD: &str = "timestamp";
const _EVENT_TIEBREAKER_FIELD: &str = "tiebreaker";
