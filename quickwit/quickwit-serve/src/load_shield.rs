...
impl LoadShield {
    ...
    pub async fn acquire_permit(&'static self) -> Result<LoadShieldPermit, warp::Rejection> {
        let pending_gauge_guard =
            GaugeGuard::from_gauge_with_initial_value(&self.pending_gauge, 1i64);
        ...
        let ongoing_gauge_guard =
            GaugeGuard::from_gauge_with_initial_value(&self.ongoing_gauge, 1i64);
        Ok(LoadShieldPermit {
