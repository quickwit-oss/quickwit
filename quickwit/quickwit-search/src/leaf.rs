...
/// Adds CacheNodes in part of the queryi, following rules specific to Datadog queries
///
...
///
/// CacheNode for queries are not added here, but directly when converting from EVP AST to Quickwit
/// AST, as EVP provides hint of where to add those CacheNodes directly.
