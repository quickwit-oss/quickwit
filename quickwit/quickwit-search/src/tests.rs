...
async fn test_single_node_simple() -> anyhow::Result<()> {
    ...
    let search_request = SearchRequest {
        ...
        query: Some("anthropomorphic".to_string()),
...
async fn test_single_node_termset() -> anyhow::Result<()> {
    ...
    let search_request = SearchRequest {
        index_id: index_id.to_string(),
        query: Some("title: IN [beagle]".to_string()),
        query_dsl: None,
        start_timestamp: None,
        end_timestamp: None,
        max_hits: 2,
...
async fn test_single_node_filtering() -> anyhow::Result<()> {
    ...
    let search_request = SearchRequest {
        index_id: index_id.to_string(),
        query: Some("tag:foo AND info".to_string()),
        query_dsl: None,
        search_fields: vec![],
        start_timestamp: None,
        end_timestamp: None,
...
async fn test_single_node_split_pruning_by_tags() -> anyhow::Result<()> {
    ...
    let selected_splits = list_relevant_splits(
        &SearchRequest {
            index_id: index_id.to_string(),
            query: Some("owner:francois".to_string()),
            query_dsl: None,
            ..Default::default()
        },
        &*test_sandbox.metastore(),
    ...
    let selected_splits = list_relevant_splits(
        &SearchRequest {
            index_id: index_id.to_string(),
            query: Some("owner:francois OR owner:paul OR owner:adrien".to_string()),
            query_dsl: None,
            ..Default::default()
        },
        &*test_sandbox.metastore(),
...
async fn test_single_node_with_ip_field() -> anyhow::Result<()> {
    ...
    }
    {
        let search_request = SearchRequest {
            index_id: index_id.to_string(),
            query: Some("10.10.11.125".to_string()),
            query_dsl: None,
            search_fields: vec!["host".to_string()],
            start_timestamp: None,
            end_timestamp: None,
...
async fn test_single_node_range_queries() -> anyhow::Result<()> {
    ...
    test_sandbox.add_documents(docs).await?;
    {
        let search_request = SearchRequest {
            index_id: index_id.to_string(),
            query: Some("datetime:[2023-01-10T15:13:36Z TO 2023-01-10T15:13:38Z}".to_string()),
            query_dsl: None,
            search_fields: Vec::new(),
            start_timestamp: None,
            end_timestamp: None,
    ...
    }
    {
        let search_request = SearchRequest {
            index_id: index_id.to_string(),
            query: Some("status_code:[400 TO 401]".to_string()),
            query_dsl: None,
            search_fields: Vec::new(),
            start_timestamp: None,
            end_timestamp: None,
    ...
    }
    {
        let search_request = SearchRequest {
            index_id: index_id.to_string(),
            query: Some("host:[10.0.0.0 TO 10.255.255.255]".to_string()),
            query_dsl: None,
            search_fields: Vec::new(),
            start_timestamp: None,
            end_timestamp: None,
    ...
    }
    {
        let search_request = SearchRequest {
            index_id: index_id.to_string(),
            query: Some("latency:[100 TO *]".to_string()),
            query_dsl: None,
            search_fields: Vec::new(),
            start_timestamp: None,
            end_timestamp: None,
    ...
    }
    {
        let search_request = SearchRequest {
            index_id: index_id.to_string(),
            query: Some("error_code:[-1 TO 1]".to_string()),
            query_dsl: None,
            search_fields: Vec::new(),
            start_timestamp: None,
            end_timestamp: None,
