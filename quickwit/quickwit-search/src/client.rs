...
use http::Uri;
use quickwit_cluster::ServiceClientBuilder;
...
#[async_trait]
impl ServiceClientBuilder for SearchServiceClient {
    fn service() -> QuickwitService {
        QuickwitService::Searcher
    }

    async fn build_client(grpc_addr: SocketAddr) -> anyhow::Result<SearchServiceClient> {
