...
use crate::metrics::{
    DD_PENDING_MERGE_OPS, ONGOING_MERGE_OPERATIONS, PENDING_MERGE_BYTES, PENDING_MERGE_OPERATIONS,
};
...
impl MergeSchedulerService {
    ...
    fn schedule_pending_merges(&mut self, ctx: &ActorContext<Self>) {
        ...
        loop {
            ...
            DD_PENDING_MERGE_OPS.set(self.pending_merge_queue.len() as f64);
