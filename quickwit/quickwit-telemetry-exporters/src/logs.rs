...
/// Example output:
/// ```json
/// {"timestamp":"2025-03-23T14:30:45Z","level":"INFO","service":"byoc","ddsource":"byoc","message":"INFO quickwit_search: hello","key":"value","count":42}
/// ```
    ...
    N: for<'a> FormatFields<'a> + 'static,
{
    fn format_event(
        ...
        output.insert("service".to_string(), "byoc".into());
        output.insert("ddsource".to_string(), "byoc".into());
