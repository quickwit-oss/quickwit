...
//! data sources (metrics, tantivy, ...) live in downstream crates that
//! implement the [`data_source::QuickwitDataSource`] trait.
//!
//! ## Features
//!
...
pub use data_source::{DataSourceContributions, QuickwitDataSource};
