...
**Quickwit** is a distributed search engine built from the ground up to achieve high cost-efficiency, high reliability while keeping its architecture simple and manageable for the mere mortals.


# Why Quickwit?
Quickwit is born from the idea that today's search engines are hard to manage and too costly on specific use cases like low QPS in a multitenancy environment.
